...
if(lastGeneration == true )
	...
	Population.prototype.Evolve = function(generationNumber, populationSize, storeNonDominatedSolutions) {
...
//				storeNonDominatedSolutions[generationNumber] = onlyParetoIndividuals;
	...
	function init(populationSize, generationSize, variables, debtItems) {
		...
		return pop.Evolve(generationSize, populationSize, storeNonDominatedIndividuals);
